...
class OpenAIExtractor:
    ...
    def _system_prompt(self) -> str:
        return (
            ...
            "- Si la línea termina en un número suelto después de un guion (-, –, —), ese número ES\n"
            "  la cantidad, aunque no traiga unidad. Ejemplo: 'CANALETA 8X4 NEGRA — 20' => \n"
            "  description='CANALETA 8X4 NEGRA', quantity=20, uom='UND'.\n"
            "  La cantidad NO debe quedar dentro de description.\n"
            "- OJO: no confundas specs con cantidad. En '2x40', '#12', '4/0 AWG', '110V', '20A' el\n"
            "  número es parte de la descripción, no la cantidad.\n"
